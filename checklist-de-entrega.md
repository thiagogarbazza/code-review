...
### CKE01-04 Habilitação / Desabilitação 
...
| CKE02-06.04 | Em períodos (De - Até), testar se o sistema realiza verificação caso a data do campo "De:" seja posterior à data do campo "Até:".                 |          |             |
...
### CKE02-12 Campos do tipo input file
